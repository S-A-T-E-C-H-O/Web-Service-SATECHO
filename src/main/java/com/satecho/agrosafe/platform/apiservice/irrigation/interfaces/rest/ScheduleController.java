...
import com.satecho.agrosafe.platform.irrigation.application.commandservices.ScheduleCommandService;
import com.satecho.agrosafe.platform.irrigation.application.queryservices.ScheduleQueryService;
import com.satecho.agrosafe.platform.irrigation.domain.model.commands.CreateScheduleCommand;
import com.satecho.agrosafe.platform.irrigation.domain.model.commands.DeleteScheduleCommand;
import com.satecho.agrosafe.platform.irrigation.domain.model.commands.UpdateScheduleCommand;
import com.satecho.agrosafe.platform.irrigation.domain.model.queries.GetScheduleByIdQuery;
import com.satecho.agrosafe.platform.irrigation.domain.model.queries.GetSchedulesByZoneQuery;
import com.satecho.agrosafe.platform.irrigation.domain.model.valueobjects.RecurrencePattern;
import com.satecho.agrosafe.platform.irrigation.interfaces.rest.resources.CreateScheduleResource;
import com.satecho.agrosafe.platform.irrigation.interfaces.rest.resources.IrrigationScheduleResource;
import com.satecho.agrosafe.platform.irrigation.interfaces.rest.resources.UpdateScheduleResource;
import com.satecho.agrosafe.platform.irrigation.interfaces.rest.transform.IrrigationScheduleResourceFromEntityAssembler;
