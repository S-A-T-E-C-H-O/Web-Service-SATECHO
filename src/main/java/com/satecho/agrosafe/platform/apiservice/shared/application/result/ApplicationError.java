package com.satecho.agrosafe.platform.apiservice.shared.application.result;
...
public record ApplicationError(
    ...
    /**
     * Forbidden error: authenticated user is not allowed to perform this action
     */
    public static ApplicationError forbidden(String resource, String reason) {
        return new ApplicationError("FORBIDDEN", "Access denied for %s".formatted(resource), reason);
    }
